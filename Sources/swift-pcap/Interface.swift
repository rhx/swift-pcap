...
public struct Interface: CustomStringConvertible {
    ...
    public struct Flags: OptionSet {
        ...
        public static let loopback = Flags(rawValue: PCAP_IF_LOOPBACK)
        /// Interface is up
        public static let up = Flags(rawValue: PCAP_IF_UP)
        /// Interface is running
        public static let running = Flags(rawValue: PCAP_IF_RUNNING)
        /// Interface is a wireless interface
        public static let wireless = Flags(rawValue: PCAP_IF_WIRELESS)
    }
